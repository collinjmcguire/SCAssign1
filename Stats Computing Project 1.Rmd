...
baseplot + geom_point() +
  facet_wrap(feature ~ ., scales = "free_y", shrink = TRUE) +
  geom_smooth() +
  labs(title = "Song Characteristics by Year", subtitle = "Characteristics such as energy, tempo, and instrumentalness all reached a nadir around the late \n 1990's and early 2000's before climbing again to a peak in the 2010's. Loudness, danceability, \n and speechiness, however, all started off relatively lower than the other three characteristics, \n but steadily increased to their maximum as the years progressed.", caption = "Collin McGuire", x = "Year", y = "Average Characteristic Value") +
  theme_bw()
