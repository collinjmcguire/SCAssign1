...
baseplot <- ggplot(tidy_average_by_year, aes(x = year_released, y = mean_score))
baseplot + geom_point(color = "sienna3") +
  facet_wrap(feature ~ ., scales = "free_y", shrink = TRUE) +
  geom_smooth() +
  labs(title = "Song Characteristics by Year", x = "Year", y = "Average Characteristic Value")
